...
<head>
    ...
    <title>@yield('title', 'Dashboard Admin') - MEDCAMPUS</title>
...
<body class="font-sans bg-gray-50">
    <div class="flex h-screen overflow-hidden">
        <aside class="hidden lg:flex lg:flex-shrink-0">
            <div class="w-64 bg-gradient-to-b from-primary-900 via-primary-800 to-gray-900 flex flex-col">
                <div class="flex items-center gap-2 px-6 py-5 border-b border-white/10">
                    ...
                    <div>
                        ...
                        <small class="text-white/50 text-xs">Admin Panel</small>
                    </div>
                </div>
                <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto scrollbar-thin">
                    ...
                    <a href="{{ route('admin.jadwal-dokter') }}" class="sidebar-link {{ request()->routeIs('admin.jadwal-dokter*') ? 'active' : '' }}">
                    ...
                    <a href="{{ route('admin.kelola-antrian') }}" class="sidebar-link {{ request()->routeIs('admin.kelola-antrian*') ? 'active' : '' }}">
                    ...
                    <a href="{{ route('admin.rekam-medis') }}" class="sidebar-link {{ request()->routeIs('admin.rekam-medis*') ? 'active' : '' }}">
                    ...
                    <a href="{{ route('admin.obat') }}" class="sidebar-link {{ request()->routeIs('admin.obat*') ? 'active' : '' }}">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.5 12c0 4.142-3.358 7.5-7.5 7.5S4.5 16.142 4.5 12 7.858 4.5 12 4.5 19.5 7.858 19.5 12z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l2.5 2.5"/></svg>
                        Data Obat
                    </a>
                    <a href="{{ route('admin.pembayaran') }}" class="sidebar-link {{ request()->routeIs('admin.pembayaran*') ? 'active' : '' }}">
