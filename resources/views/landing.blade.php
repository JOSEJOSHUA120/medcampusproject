    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="bg-white rounded-2xl shadow-sm p-6 text-center hover:shadow-md transition-all duration-200">
                ...
                <div class="text-sm text-gray-500 font-semibold uppercase tracking-wider mt-1">Booking Diproses</div>
            </div>
            <div class="bg-white rounded-2xl shadow-sm p-6 text-center hover:shadow-md transition-all duration-200">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="bg-white rounded-2xl shadow-sm p-8 border border-gray-100 hover:shadow-lg transition-all duration-200">
                ...
                <h5 class="text-lg font-bold font-display mb-2">Booking Online</h5>
                <p class="text-gray-500 text-sm leading-relaxed mb-0">Booking janji temu dokter dari mana saja tanpa perlu datang langsung.</p>
            </div>
            <div class="bg-white rounded-2xl shadow-sm p-8 border border-gray-100 hover:shadow-lg transition-all duration-200">
                <div class="text-5xl mb-4">💊</div>
