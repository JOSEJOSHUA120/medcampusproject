...
<div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
    <div class="flex items-center justify-between mb-4 flex-wrap gap-3">
        <h5 class="font-bold text-gray-800">Daftar Pasien</h5>
        ...
        <table id="dataTable" class="w-full text-left">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th class="px-4 py-3 text-xs font-semibold text-gray-600 uppercase tracking-wider">Jenis Kelamin</th>
            ...
            <tbody>
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-4 py-3 border-b border-gray-100 text-sm">{{ $d->user->name }}</td>
                    ...
                    <td class="px-4 py-3 border-b border-gray-100 text-sm">{{ $d->jenis_kelamin == 'L' ? 'Laki-Laki' : ($d->jenis_kelamin == 'P' ? 'Perempuan' : '-') }}</td>
