...
Route::middleware(['auth', 'dokter'])->prefix('dokter')->name('dokter.')->group(function () {
    ...
    Route::post('/rekam-medis/pilih-pasien', [DokterController::class, 'rekamMedisPilihPasienStore'])->name('rekam-medis.pilih-pasien.store');
    ...
    Route::put('/booking/{id}/panggil', [BookingController::class, 'dokterPanggil'])->name('booking.panggil');
